<template>
  <section class="faq container py-10 md:py-16 flex flex-col md:flex-row md:gap-20 text-black">
    <h2 class="mb-6 md:mb-0 md:basis-1/3" v-text="'Frequently asked questions'" />
    <Accordion class="md:flex-1">
      <AccordionItem initially-open>
        <template #title>
          What is Bluvv?
        </template>
      ...
      <AccordionItem>
        ...
        <p v-text="'You earn rewards by sharing your genuine experiences via video reviews and for every interaction on app.'" />
      </AccordionItem>
      <AccordionItem>
        <template #title>
